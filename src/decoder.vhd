...
BEGIN
    ...
    WITH EnS SELECT
        OP <= "0000000000000000" WHEN "10000",   -- S = 0000
              "0000000000000001" WHEN "10001",   -- S = 0001
              "0000000000000010" WHEN "10010",   -- S = 0010
              "0000000000000100" WHEN "10011",   -- S = 0011
              "0000000000001000" WHEN "10100",   -- S = 0100
              "0000000000010000" WHEN "10101",   -- S = 0101
              "0000000000100000" WHEN "10110",   -- S = 0110
              "0000000001000000" WHEN "10111",   -- S = 0111
              "0000000010000000" WHEN "11000",   -- S = 1000
              -- "0000000100000000" WHEN "11001",   -- S = 1001
